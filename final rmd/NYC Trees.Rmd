...
mydata <- read_csv('2015NYCTrees.csv')
...
Our data set has very few missing values and when looking at the original csv file, it seems that the missing values are due to the tree being dead or stump. To confirm our hypothesis, we made a bar plot of missing value by variable, grouped by status.
